...
class ExceptionNoUndo : public std::exception
{
private:
	std::string message;
public:
	bool exists;
	ExceptionNoUndo(std::string message);
	const char* what() const throw() override;

};

class ExceptionNoRedo : public std::exception
{
private:
	std::string message;
public:
	bool exists;
	ExceptionNoRedo(std::string message);
	const char* what() const throw() override;
