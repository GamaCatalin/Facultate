...
*/
    ...
    private static IStatement init10(){
        return new CompoundStatement(new VariableDeclarationStatement("v", new BooleanType()),
                new CompoundStatement(new AssignStatement("v", new Number(2)),
                        new PrintStatement(new VariableExpression("v"))));
    }

    private static Controller ex10(){
        IDictionary<String, IValue> dict;
        IStack<IStatement> stack;
        IList<IValue> list;
        RepositoryMemory repo;
        ...
        try {
            ...
            exceptionInvalidValue.printStackTrace();
            System.out.println("ERROR ON EX 10: " + exceptionInvalidValue.getMessage());
        }
        stack.push(statement);
        repo.addProgramState(new ProgramState(stack, dict, list));
        cont = new Controller(repo);
        cont.setRepoLogFilePath("testLog10.txt");
        return cont;
    }
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        IStatement stm10 = init10();
        Controller cont10 = ex10();
        ...
        //menu.addCommand(new RunExample("10", stm10.toString(),cont10));
