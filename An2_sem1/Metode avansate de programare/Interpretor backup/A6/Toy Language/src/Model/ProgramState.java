...
public class ProgramState {
    ...
    public ProgramState oneStep() throws exceptionStackIsEmpty, IOException, exceptionExpressionNotOfStringType, exceptionKeyAlreadyInDictionary, exceptionVariableNotDeclared, exceptionFileNotFound, exceptionDivisionByZero, exceptionDifferentOperandTypes, exceptionInvalidOperation, exceptionInvalidValue, exceptionKeyNotFound {
    ...
    public String toString() {
        ...
        builder.append("###############################################################################\n");
        builder.append("Thread ID: " + this.id);
        builder.append("\n\n");
